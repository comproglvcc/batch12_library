<?php
	...
	if ((empty($_SESSION)) || ($_SESSION['level']!== 'admin')){
		header("location:../index.php");
			...
			$id=$_GET['id'];
			$borrower= UserUtils::eachUser($id);
...
<p style="font-family: 'Impact', Helvetica, Arial, sans-serif;
	...
	color:white; background:black;">View a Borrower</p>

	<table class="altrowstable" style="margin-top:40px; margin-left:50px; width:700px;">
<?php foreach ($borrower as $bor): ?>
	<tr>
					<td><h2 style = "font-style:normal;">Student Id</h2></td> 
					<td> <?php echo $bor['student_id']; ?></td>
				</tr>
				
				<tr>
					<td ><h2 style = "font-style:normal;">Student Name</h2></td>
					<td> <?php echo $bor['firstname']." ". $bor['lastname']; ?> </td>
				</tr>
				
				<tr>
					<td ><h2 style = "font-style:normal;">Year and Course</h2></td>
					<td> <?php echo $bor['course']; ?></td>
				</tr> 
				
				<tr>
					<td ><h2 style = "font-style:normal;">Username</h2></td>
					<td> <?php echo $bor['username']; ?></td>
				</tr> 
				
				<tr>
					<td ><h2 style = "font-style:normal;">Email Address</h2></td>
					<td> <?php echo $bor['email']; ?></td>
				</tr> 
				
				<tr>
					<td  style='min-width:30px;'><h2 style = "font-style:normal;">Address</h2></td>
					<td> <?php echo $bor['address']; ?></td>
				</tr> 
				
				<tr>
					<td ><h2 style = "font-style:normal;">Contact Number</h2></td>
