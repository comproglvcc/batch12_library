...
<h2 style = "margin-top:10px;float:center;text-align:center;">Registered LVCC Students</h2>
<hr/>	
	<table style="margin-top:10px; margin-left:20px; width:700px;">

	<tr style="text-align:center;border:solid blue;">
		<td><h2 style = "font-style:normal;">Student Number</h2></td>
		<td><h2 style = "font-style:normal;">Full Name</h2></td>
		<td><h2 style = "font-style:normal;">Username</h2></td>	
		<td><h2 style = "font-style:normal;">Email Address</h2></td>
	</tr>
	</table>
</div>
...
<div style="width:850px;height:400px;">
	...
	<tr class="buk">
		<td style = "width:205px;"><?php echo $user['student_id']; ?></td>
		<td style = "width:130px;"><?php echo $user['firstname'] . " " . $user['lastname']; ?> </td>
		<td style = "width:125px;"><?php echo $user['username']; ?></td>
		<td><?php echo $user['email']; ?></td>
		<td><a href="eachBorrower.php?id=<?php echo $user['id']; ?>"><img src="../includes/img/view.png" title="View details"></a></td>
		<td><a href="delUsers.php?id=<?php echo $user['id']; ?>"><img src="../includes/img/delete.png" title="Disable" onclick='return confirm("Are you sure you want to delete this student?")'></a></td>
	</tr>
	<?php endforeach;?>
	</table>
