...
<div id="container">
	...
	<div id = "contentC">
	<table class="altrowstable" id="alternatecolor" style="margin-top:20px;width:850px; margin-left:20px;">
			   <body>
<tr>
...
<div style="margin-bottom:10px; height:290px;overflow:auto;">
	<table class="altrowstable" id="alternatecolor" style="margin-top:0px;width:850px; margin-left:20px;"">

<td>
	<p > The <b>classes </b>are: </p>
	<p align='center'><img src='../includes/img/class/dewey.gif' height='450' width='500' ></p><br/>
        <p><b>References</b> </p><hr><br/>
	<a href='http://en.wikipedia.org/wiki/Dewey_Decimal_Classification'> ^ wikipedia.org</a>

</td>
<tr>
	<td align='left'> <a href='getClass.php'><input type='button' value='View Classification'></a> </td>
	<td align='right'> <a href='aboutddc.php'><input type='button' value='<< Previous'> </a></td>
</tr>
</body>
