...
<p style="font-family: 'Impact', Helvetica, Arial, sans-serif;
	...
	color:white; background:black;">Add a Transaction</p>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method='POST'>
	<table class="altrowstable" style="margin-top:40px;margin-left:150px; width:500px;">
	    ...
	    <tr>
				   ...
				   <?php @$id=$_GET['id'];?>
                       ...
                       <td ><h2 style = "font-style:normal;">Book Accession Number</h2></td>
                       <td><input type='text' name='bAccess' id='bAccess' value="<?php echo $id; ?>" size='20'/></td>
                   </tr>
				   <tr>
                       <td ><h2 style = "font-style:normal;">Date Issue</h2></td>
                       <td>
		...
		<?php endfor;?>
			...
			<span id="help_date"></span>
                   ...
                   <tr>
                       <td ><h2 style = "font-style:normal;">Date Due</h2></td>
                       <td>
		...
		<?php endfor;?>
			...
			<span id="help_date"></span>
                   ...
                   <tr>
                   <td colspan='2' align='center'><input type = 'submit' name='trans' value='submit'/></td>
                   </tr>
	</table>
	</form>
</div>
